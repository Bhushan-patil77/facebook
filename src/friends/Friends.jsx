...
import { MdCake, MdGroups } from 'react-icons/md'
  ...
  return (
    <>
      ...
      <div className='bg-[#f0f2f5] w-screen border-1 border-red-500 h-[720px] py-1 flex justify-between'>
        ...
        <div className="left bg-white rounded-lg hidden xl:flex flex-col w-[22%] h-full p-2 ">
        ...
        <div className="right bg-gray-100 rounded-lg  w-full xl:w-[77%] h-full xl:p-6 p-3 flex flex-col gap-8 xl:gap-12  overflow-y-auto no-scrollbar ">
 
          <ul className='flex gap-2  opacity-0 mountAnimation whitespace-nowrap w-full overflow-x-auto no-scrollbar min-h-[30px]  text-sm  font-semibold'>
            <li className='flex items-center gap-3 rounded-full px-4  bg-gray-300'> <span className='flex justify-center items-center  rounded-full text-blue-500'> <BiSolidHome />  </span>  <p className='text-blue-500'>Home</p></li>
            <li className='flex items-center gap-3 rounded-full px-4  bg-gray-300'> <span className='flex justify-center items-center  rounded-full'> <FaUserPlus /> </span>  <p>Friend Requests</p> </li>
            <li className='flex items-center gap-3 rounded-full px-4  bg-gray-300'> <span className='flex justify-center items-center  rounded-full'> <TiCog /> </span>  <p>Suggestions</p></li>
            <li className='flex items-center gap-3 rounded-full px-4  bg-gray-300'> <span className='flex justify-center items-center  rounded-full'> <MdGroups /> </span>  <p>All friends</p> </li>
            <li className='flex items-center gap-3 rounded-full px-4  bg-gray-300'> <span className='flex justify-center items-center  rounded-full'> <MdCake /> </span>  <p>Birthdays</p> </li>
          </ul>
