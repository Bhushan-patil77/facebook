  ...
  return (
    ...
    <>
      ...
      <div className={`bg-[#f0f2f5] w-screen  h-[720px] py- flex justify-between`}>
        ...
        <div className="center w-[54%]  px-16 bg-white rounded-lg border flex flex-col  gap-4 items-center pt-4 overflow-y-auto no-scrollbar">
        ...
        <div className="right w-[24%] bg-white rounded-lg border flex flex-col gap-4  overflow-y-auto no-scrollbar p-4">
