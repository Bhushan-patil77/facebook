...
function Profile() {
    ...
    const getPosts = async () => {
        ...
        const url = `https://academics.newtonschool.co/api/v1/facebook/post?filter={"author._id":"${userInfo}"}`
        const projectId = '6xetdqeg0242';
    ...
    return (
        <div className='flex flex-col items-center overflow-y-auto no-scrollbar  w-full max-h-screen  '>
            <div className='w-full flex justify-center items-center bg-white '>
                <div className="coverPhotoContainer flex flex-col gap- relative   rounded-lg w-full xl:w-[70%]   xl:mb-4">
                    ...
                    <div className="bottom flex xl:flex-row flex-col gap-2 justify-between xl:pl-[240px]   xl:p-8  ">
                        <div className="name xl:text-3xl xl:ml-0 ml-[120px] xl:px-0 font-bold p-3 xl:p-0 ">Bhushan Patil</div>
            ...
            <div className='  xl:hidden flex  w-full justify-center bg-gray-100'>
                ...
                <div className="bottom flex flex-col gap-4 w-full max-h-[720px] overflow-y-auto no-scrollbar pt-4 ">

                    <div className="top w-full flex flex-col gap-4 sticky top-0 border">
                        <div className="intro flex flex-col gap-2 justify-between w-full p-3 shadow rounded-lg bg-white text-gray-500">
                            <span className='text-2xl font-bold text-black'>Intro</span>
                            <div className='flex items-center gap-4'><FaRegUser /> <span>{'Bhushan Patil'}</span></div>
                            <div className='flex items-center gap-4'><PiGenderMaleBold  /> <span>{'Male'}</span></div>
                            <div className='flex items-center gap-4'><MdOutlineMailOutline /> <span>{'Bhushan@gmail.com'}</span></div>
                            <div className='flex items-center gap-4'><TbPhoneCalling /> <span>{'9834832178'}</span></div>
                        </div>
                    ...
                    <div className="posts flex flex-col gap-5 w-full px-1 ">
                        <div className="createPost bg-white w-full rounded-lg p-3 flex flex-col gap-3 shadow" onClick={(e) => { handleButtonClick(e, createPostPopup) }}>

                            <div className="upper flex items-center justify-between ">
                                <div className="profilePhoto flex justify-center items-center rounded-full w-[40px] h-[40px] bg-slate-400 border "> <img className='rounded-full' src={userIcon} alt="" /> </div>
                                <div className="inputDiv border rounded-full w-[84%] flex pl-3 items-center h-[40px] bg-gray-100 text-gray-400 hover:bg-gray-200 cursor-pointer">What's on your mind, Bhushan</div>
                            </div>

                            <div className='border-b' />

                            <div className="lower flex justify-between gap-1 text-sm">
                                <div className="liveVideo flex gap-2 items-center justify-center w-full py-1 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100"> <img src={liveVideoIcon} className='w-[15%]' alt="" /> <span>Live video</span> </div>
                                <div className='photo/video flex gap-2 items-center justify-center w-full py-1 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100'> <img src={photosAndVideosIcon} className='w-[15%]' alt="" /> <span>Live video</span> </div>
                                <div className='feeling/activity flex gap-2 items-center justify-center w-full py-1 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100'> <img src={feelingActivityIcon} className='w-[15%]' alt="" /> <span>Live video</span> </div>
                            </div>
