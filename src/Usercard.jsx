  ...
  return (
    <div className='w-[230px] h-[385px] border rounded-md flex flex-col justify-between bg-white shadow'>
      <div className="imageAndName flex flex-col">
        <div className='w-full h-[230px] rounded-md '><img className='w-full h-full object-cover  rounded-t-md' src={technology} alt="" /></div>
        <span className='font-semibold p-2'>Bhushan patil</span>
      </div>
